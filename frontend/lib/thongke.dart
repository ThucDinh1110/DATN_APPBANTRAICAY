                            ...
                            children: [
                              Text('CHI TIẾT DOANH THU',
                                  style: theme.textTheme.titleLarge
                                      ?.copyWith(fontWeight: FontWeight.bold)),
                              SizedBox(height: 16),
                              _buildInfoTile('Doanh thu dự tính:',
                                  formatCurrency(duTinh), Icons.trending_up, Colors.orange),
                              _buildInfoTile('Doanh thu thực tế:',
                                  formatCurrency(thucTe), Icons.assessment, Colors.green),
                              _buildInfoTile('Đơn đã hủy:',
                                  formatCurrency(huy), Icons.cancel, Colors.red),
                              _buildInfoTile('Chờ duyệt:',
                                  formatCurrency(choDuyet), Icons.schedule, Colors.blueGrey),
                              _buildInfoTile('Đã duyệt:',
                                  formatCurrency(daDuyet), Icons.verified, Colors.blue),
                              _buildInfoTile('Đang giao:',
                                  formatCurrency(dangGiao), Icons.local_shipping, Colors.purple),
                              Divider(),
                              _buildInfoTile('Chênh lệch:',
                                  formatCurrency(thucTe - duTinh),
                                  thucTe >= duTinh ? Icons.arrow_upward : Icons.arrow_downward,
                                  thucTe >= duTinh ? Colors.green : Colors.red),
                              _buildInfoTile('Tỷ lệ đạt được:',
                                  duTinh == 0
                                      ? '0%'
                                      : '${(thucTe / duTinh * 100).toStringAsFixed(2)}%',
                                  Icons.percent,
                                  Colors.teal),
                            ],
                          ),
